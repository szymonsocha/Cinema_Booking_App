% rebase('admin_base.tpl', title='Login')
    <!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <span class="badge bg-success"><i class="bi bi-check-circle me-1"></i> Congratulations, {{!loginName}}! You logged in successfully!</span>
